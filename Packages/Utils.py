class JSONAdaptor:
  # The internal Python representation of the data need to be converted to viable JSON for storage in a User-Friendly Settings file.
  # The stored JSON settings need to be translated back into interal python before being run.
